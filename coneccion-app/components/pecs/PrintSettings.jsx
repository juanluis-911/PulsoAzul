...
import { PAPER_SIZES, PICTO_SIZES } from './constants'
import { X } from 'lucide-react'

export function PrintSettings({ settings, onChange, onConfirm, onClose, generating }) {
  return (
        ...
        <div className="flex items-center gap-6">
          <label className="flex items-center gap-2 text-sm text-slate-700 cursor-pointer select-none">
            <input
              ...
              onChange={(e) => onChange({ ...settings, showBorder: e.target.checked })}
